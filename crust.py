...
class Crust:
	...
	def composition(self,P):
		...
		Pmax = [7.235e26,9.569e27,1.152e29,4.747e29,1.361e30,1.980e30,2.253e30,2.637e30,2.771e30,3.216e30,3.825e30,4.699e30,6.043e30,7.233e30,9.238e30,1.228e31,1.602e31,1.613e31,1e33]
		for (Acell1,A1,Z1,Pmax1) in zip(Acella,Aa,Za,Pmax):
			if P<numpy.log10(Pmax1):
				Acell=Acell1
				A=A1
				Z=Z1
				break
